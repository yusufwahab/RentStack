    ...
    <div className="min-h-screen flex">
      ...
      <div className="flex-1 flex flex-col justify-center px-8 md:px-16 bg-white">
        <div className="max-w-sm w-full mx-auto">
          ...
          <h1 className="mt-8 text-2xl font-bold text-[#0F172A]">Welcome back</h1>
          ...
          <p className="mt-6 text-sm text-[#64748B]">
            ...
            <Link to="/register" className="text-[#C9A84C] font-medium hover:underline">Get started</Link>
          </p>
          <p className="mt-2 text-xs text-[#94A3B8]">Demo: abdulwahab@rentstack.com / password123</p>
        </div>
      </div>
