    ...
    <div className="p-6 md:p-8 max-w-2xl">
      ...
      <div className="bg-white border border-[#E2E8F0] rounded-xl p-6 mb-6">
        ...
        <form onSubmit={handleSave} className="space-y-4">
          ...
          <button
            type="submit"
            className="bg-[#0F172A] text-white px-6 py-2.5 rounded-lg text-sm font-medium hover:bg-[#1E293B] transition-colors duration-200"
          >
      ...
      <div className="bg-white border border-[#E2E8F0] rounded-xl p-6">
        ...
        <div className="flex items-center gap-3">
          ...
          <input
            ...
            className="border border-[#E2E8F0] rounded-lg px-4 py-2.5 text-sm w-40 focus:outline-none focus:ring-2 focus:ring-[#C9A84C]/40"
          />
        </div>
      </div>
    </div>
